...
class ConnectionManager extends ConnectionManager_Base
{
	...
	protected function _setConnectionsData()
	{
		...
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;127.0.0.1;root;1qaz2wsx;3307;dbsep;;1"; //currently unused
		...
		$data["connInfo"][2] = "1qaz2wsx";
		$data["connInfo"][3] = "3307";
		$data["connInfo"][4] = "dbsep";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=127.0.0.1;Uid=root;Pwd=1qaz2wsx;Port=3307;Database=dbsep;OPTION=3";
		// encription set
		$data["EncryptInfo"] = array();
		$data["EncryptInfo"]["mode"] = 0;
		$data["EncryptInfo"]["alg"]  = 128;
