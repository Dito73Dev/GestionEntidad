...
require_once("include/contrato_attached_type_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "contrato_attached_type" );
