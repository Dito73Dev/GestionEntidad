...
require_once("include/interventor_periodos_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "interventor_periodos" );
