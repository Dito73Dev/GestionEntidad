...
require_once("include/global_users_contratistas_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "global_users_contratistas" );
