...
require_once("include/contrato_tipo_unidad_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "contrato_tipo_unidad" );
