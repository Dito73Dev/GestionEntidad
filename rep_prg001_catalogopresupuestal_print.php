...
require_once("include/rep_prg001_catalogopresupuestal_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "rep_prg001_catalogopresupuestal" );
