...
$tdatatipo_docidentidad[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatatipo_docidentidad[".originalPagesByType"] = $tdatatipo_docidentidad[".pagesByType"];
$tdatatipo_docidentidad[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatatipo_docidentidad[".originalPages"] = $tdatatipo_docidentidad[".pages"];
$tdatatipo_docidentidad[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\"}" );
...
$tdatatipo_docidentidad[".badgeColor"] = "EDCA00";
...
$tableKeystipo_docidentidad[] = "codigo";
