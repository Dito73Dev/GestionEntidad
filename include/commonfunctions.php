...
function checkTableName($shortTName )
{
	...
	if ("dependencias_001" == $shortTName )
		return true;
	if ("dependencia" == $shortTName )
		return true;
	if ("tparam_estados" == $shortTName )
		return true;
	if ("tparam_sn" == $shortTName )
		return true;
	if ("funcionario" == $shortTName )
		return true;
	if ("nombramiento" == $shortTName )
		return true;
	if ("contrato" == $shortTName )
		return true;
	if ("perfil" == $shortTName )
		return true;
	if ("contrato_attached_type" == $shortTName )
		return true;
	if ("tparam_tipo_ct_000" == $shortTName )
		return true;
	if ("tparam_tipo_ct_001" == $shortTName )
		return true;
	if ("tparam_tipo_ct_002" == $shortTName )
		return true;
	if ("contrato_estados" == $shortTName )
		return true;
	if ("contrato_forma_pago" == $shortTName )
		return true;
	if ("contrato_natjuridica" == $shortTName )
		return true;
	if ("contrato_pre" == $shortTName )
		return true;
	if ("contrato_tipo" == $shortTName )
		return true;
	if ("contrato_tipo_unidad" == $shortTName )
		return true;
	if ("global_month" == $shortTName )
		return true;
	if ("interventor_periodos" == $shortTName )
		return true;
	if ("polizas_aseguradoras" == $shortTName )
		return true;
	if ("polizas_tipo" == $shortTName )
		return true;
	if ("tipo_banco" == $shortTName )
		return true;
	if ("tipo_cta_banco" == $shortTName )
		return true;
	if ("tipo_docidentidad" == $shortTName )
		return true;
	if ("tipo_liquidacion" == $shortTName )
		return true;
	if ("vigencia" == $shortTName )
		return true;
	if ("divipola" == $shortTName )
		return true;
	if ("global_ejecucion" == $shortTName )
		return true;
	if ("rep_prg001_catalogopresupuestal" == $shortTName )
		return true;
	if ("global_users" == $shortTName )
		return true;
	if ("global_rol_almacen" == $shortTName )
		return true;
	if ("global_rol_c" == $shortTName )
		return true;
	if ("ep_compromisos" == $shortTName )
		return true;
	if ("ep_obligaciones" == $shortTName )
		return true;
	if ("ep_agregada" == $shortTName )
		return true;
	if ("tparam_tiporubro" == $shortTName )
		return true;
	if ("tparam_cajacomp" == $shortTName )
		return true;
	if ("tparam_estcivil" == $shortTName )
		return true;
	if ("tparam_fondopension" == $shortTName )
		return true;
	if ("tparam_fondosalud" == $shortTName )
		return true;
	if ("tparam_tipo_ct_arl" == $shortTName )
		return true;
	if ("cargo" == $shortTName )
		return true;
	if ("global_users_contratistas" == $shortTName )
		return true;
	if ("contractor_master" == $shortTName )
		return true;
	if ("dependencia_sj" == $shortTName )
		return true;
	if ("funcionario_sj" == $shortTName )
		return true;
	if ("contractor_master_sj" == $shortTName )
		return true;
	if ("global_status" == $shortTName )
		return true;
	if ("007_cdp" == $shortTName )
		return true;
	if ("ep_reservas" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_estados");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_sn");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("nombramiento");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("perfil");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_attached_type");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_attached_type";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipo_ct_000");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_tipo_ct_000";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipo_ct_001");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_tipo_ct_001";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tipo_ct_002");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tparam_tipo_ct_002";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_estados");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_estados";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_forma_pago");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_forma_pago";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_natjuridica");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_natjuridica";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_pre");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("contrato_tipo_unidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="contrato_tipo_unidad";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_month");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("polizas_aseguradoras");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="polizas_aseguradoras";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("polizas_tipo");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_banco");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_cta_banco");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_docidentidad");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tipo_liquidacion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
		$arr[]="tipo_liquidacion";
	}
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("vigencia");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_ejecucion");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_rol_almacen");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("global_rol_c");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ep_agregada");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("tparam_tiporubro");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("007_cdp");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("ep_reservas");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="global_rol_almacen" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="global_rol_c" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
...
function GetBaseScriptsForPage($isDisplayLoading, $additionalScripts = "", $customText = "")
{
	...
	$result = "";
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/loadfirst.js?41163")."\"></script>";


	$result .= $additionalScripts;
	$result .= "<script type=\"text/javascript\" src=\"".GetRootPathForResources("include/lang/".getLangFileName(mlang_getcurrentlang()).".js?41163")."\"></script>";
