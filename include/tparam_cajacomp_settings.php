...
$tdatatparam_cajacomp[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatatparam_cajacomp[".originalPagesByType"] = $tdatatparam_cajacomp[".pagesByType"];
$tdatatparam_cajacomp[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatatparam_cajacomp[".originalPages"] = $tdatatparam_cajacomp[".pages"];
$tdatatparam_cajacomp[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_cajacomp["Spanish"]["caj_cdcajcom_b"] = "Código";
	$fieldToolTipstparam_cajacomp["Spanish"]["caj_cdcajcom_b"] = "";
	$placeHolderstparam_cajacomp["Spanish"]["caj_cdcajcom_b"] = "";
	$fieldLabelstparam_cajacomp["Spanish"]["caj_dscajcom_b"] = "Caja de Compensación";
