...
$tdatacontrato_attached_type[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatacontrato_attached_type[".originalPagesByType"] = $tdatacontrato_attached_type[".pagesByType"];
$tdatacontrato_attached_type[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatacontrato_attached_type[".originalPages"] = $tdatacontrato_attached_type[".pages"];
$tdatacontrato_attached_type[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelscontrato_attached_type["Spanish"]["att_type_cod"] = "Código";
	$fieldToolTipscontrato_attached_type["Spanish"]["att_type_cod"] = "";
	$placeHolderscontrato_attached_type["Spanish"]["att_type_cod"] = "";
	$fieldLabelscontrato_attached_type["Spanish"]["att_type_name"] = "Nombre";
...
$tdatacontrato_attached_type[".badgeColor"] = "B22222";
