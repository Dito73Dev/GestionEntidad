...
$tdatatparam_fondopension[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatatparam_fondopension[".originalPagesByType"] = $tdatatparam_fondopension[".pagesByType"];
$tdatatparam_fondopension[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatatparam_fondopension[".originalPages"] = $tdatatparam_fondopension[".pages"];
$tdatatparam_fondopension[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_fondopension["Spanish"]["tfo_cdfdoces_b"] = "Código";
	$fieldToolTipstparam_fondopension["Spanish"]["tfo_cdfdoces_b"] = "";
	$placeHolderstparam_fondopension["Spanish"]["tfo_cdfdoces_b"] = "";
	$fieldLabelstparam_fondopension["Spanish"]["tfo_dsfdoces_b"] = "Nombre del fondo";
...
$tdatatparam_fondopension[".badgeColor"] = "5F9EA0";
