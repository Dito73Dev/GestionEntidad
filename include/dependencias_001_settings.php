...
$tdatadependencias_001[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" );
$tdatadependencias_001[".originalPagesByType"] = $tdatadependencias_001[".pagesByType"];
$tdatadependencias_001[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"search\":[\"search\"]}" ) );
$tdatadependencias_001[".originalPages"] = $tdatadependencias_001[".pages"];
$tdatadependencias_001[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"search\":\"search\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelsdependencias_001["Spanish"]["id_depto_superior"] = "Código";
...
$tdatadependencias_001[".connId"] = "edl_at_localhost";
...
$tdatadependencias_001[".badgeColor"] = "4169E1";
...
$tableKeysdependencias_001[] = "id_depto_superior";
...
//	dependencia
		...
		$dIndex = 0;
	$detailsParam = array();
	$detailsParam["dDataSourceTable"]="dependencia";
	...
	$detailsParam["dShortTable"] = "dependencia";
	$detailsParam["dCaptionTable"] = GetTableCaption("dependencia");
	$detailsParam["masterKeys"] =array();
	$detailsParam["detailKeys"] =array();


		
	$detailsTablesData["dependencias_001"][$dIndex] = $detailsParam;

	
		$detailsTablesData["dependencias_001"][$dIndex]["masterKeys"] = array();

	$detailsTablesData["dependencias_001"][$dIndex]["masterKeys"][]="id_depto_superior";

				$detailsTablesData["dependencias_001"][$dIndex]["detailKeys"] = array();

	$detailsTablesData["dependencias_001"][$dIndex]["detailKeys"][]="id_depto_superior";
//endif
