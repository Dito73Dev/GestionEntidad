...
$tdatatipo_cta_banco[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" );
$tdatatipo_cta_banco[".originalPagesByType"] = $tdatatipo_cta_banco[".pagesByType"];
$tdatatipo_cta_banco[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"]}" ) );
$tdatatipo_cta_banco[".originalPages"] = $tdatatipo_cta_banco[".pages"];
$tdatatipo_cta_banco[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\"}" );
...
$tdatatipo_cta_banco[".badgeColor"] = "8FBC8B";
...
$tableKeystipo_cta_banco[] = "cta_numero";
