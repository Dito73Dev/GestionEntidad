...
$tdatatipo_banco[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatatipo_banco[".originalPagesByType"] = $tdatatipo_banco[".pagesByType"];
$tdatatipo_banco[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatatipo_banco[".originalPages"] = $tdatatipo_banco[".pages"];
$tdatatipo_banco[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstipo_banco["Spanish"]["banco_id"] = "Id";
...
$tdatatipo_banco[".badgeColor"] = "E67349";
...
$tdatatipo_banco[".sqlHead"] = "SELECT banco_id,  	banco_sal,  	cod_banco,  	codigo,  	nit_banco,  	nom_banco";
$tdatatipo_banco[".sqlFrom"] = "FROM tipo_banco";
$tdatatipo_banco[".sqlWhereExpr"] = "";
...
$proto0["m_strFieldList"] = "banco_id,  	banco_sal,  	cod_banco,  	codigo,  	nit_banco,  	nom_banco";
