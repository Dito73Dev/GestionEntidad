...
$tdatatparam_fondosalud[".pagesByType"] = my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatatparam_fondosalud[".originalPagesByType"] = $tdatatparam_fondosalud[".pagesByType"];
$tdatatparam_fondosalud[".pages"] = types2pages( my_json_decode( "{\"export\":[\"export\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatatparam_fondosalud[".originalPages"] = $tdatatparam_fondosalud[".pages"];
$tdatatparam_fondosalud[".defaultPages"] = my_json_decode( "{\"export\":\"export\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$fieldLabelstparam_fondosalud["Spanish"]["tfo_cdfdosal_b"] = "Código";
	$fieldToolTipstparam_fondosalud["Spanish"]["tfo_cdfdosal_b"] = "";
	$placeHolderstparam_fondosalud["Spanish"]["tfo_cdfdosal_b"] = "";
	$fieldLabelstparam_fondosalud["Spanish"]["tfo_dsfdosal_b"] = "Nombre de la EPS";
...
$tdatatparam_fondosalud[".badgeColor"] = "6493EA";
