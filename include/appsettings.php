...
$custom_labels["Spanish"] = array();
	...
	$custom_labels["Spanish"]['WERE_SENT'] = "Envío de contraseña";
	$custom_labels["Spanish"]['USERNAME_EMAIL'] = "Escriba su usuario o correo electrónico";
	$custom_labels["Spanish"]['FORGOT'] = "Solicitar contraseña";
...
$globalSettings["strSMTPUser"] = "gestion@mincit.gov.co";
$globalSettings["strSMTPServer"] = "smtp.office365.com";
$globalSettings["strSMTPPort"] = "587";
$globalSettings["strSMTPPassword"] = "Mincomercio2021*";
$globalSettings["strFromEmail"] = "gestion@mincit.gov.co";
...
$globalSettings["LandingTable"] = "funcionario";
$globalSettings["LandingPage"] = "list";
$globalSettings["LandingURL"] = "funcionario_list.php?page=list";
...
$styleOverrides["_login"] = array(
	"theme" => "cerulean",
	"size" => "normal",
	"path" => "styles\\bootstrap\\custom\\_global_login",
);
...
$globalSettings["usersDatasourceTable"] = "global_users";


$globalSettings["jwtSecret"] = "7oreeMGpy8IwKVilk4b0";
...
$projectBuildKey = "453_1662809397";
...
$tableCaptions["Spanish"]["tparam_estados"] = "Tparam Estados";
$tableCaptions["Spanish"]["tparam_sn"] = "Tparam Sn";
$tableCaptions["Spanish"]["funcionario"] = "Funcionario";
$tableCaptions["Spanish"]["nombramiento"] = "Nombramiento";
$tableCaptions["Spanish"]["contrato"] = "Contrato";
$tableCaptions["Spanish"]["perfil"] = "Perfil";
$tableCaptions["Spanish"]["contrato_attached_type"] = "Contrato Attached Type";
$tableCaptions["Spanish"]["tparam_tipo_ct_000"] = "Tipo";
$tableCaptions["Spanish"]["tparam_tipo_ct_001"] = "Modalidad";
$tableCaptions["Spanish"]["tparam_tipo_ct_002"] = "Causal";
$tableCaptions["Spanish"]["contrato_estados"] = "Contrato Estados";
$tableCaptions["Spanish"]["contrato_forma_pago"] = "Contrato Forma Pago";
$tableCaptions["Spanish"]["contrato_natjuridica"] = "Contrato Natjuridica";
$tableCaptions["Spanish"]["contrato_pre"] = "Contrato Pre";
$tableCaptions["Spanish"]["contrato_tipo"] = "Contrato Tipo";
$tableCaptions["Spanish"]["contrato_tipo_unidad"] = "Contrato Tipo Unidad";
$tableCaptions["Spanish"]["global_month"] = "Global Month";
...
$tableCaptions["Spanish"]["tipo_liquidacion"] = "Tipo Liquidacion";
...
$tableCaptions["Spanish"]["global_users"] = "Usuarios y permisos";
$tableCaptions["Spanish"]["global_rol_almacen"] = "Global Rol Almacen";
$tableCaptions["Spanish"]["global_rol_c"] = "Global Rol C";
$tableCaptions["Spanish"]["ep_compromisos"] = "Ep Compromisos";
$tableCaptions["Spanish"]["ep_obligaciones"] = "Ep Obligaciones";
$tableCaptions["Spanish"]["ep_agregada"] = "Ep Agregada";
...
$tableCaptions["Spanish"]["007_cdp"] = "007 Cdp";
$tableCaptions["Spanish"]["ep_reservas"] = "Ep Reservas";
...
if(mlang_getcurrentlang()=="Spanish")
{
	...
	$page_titles[GLOBAL_PAGES_SHORT]["Spanish"]["remind"] = "Solicitud de nueva contraseña";
}
...
$_SESSION['urlweb'] = "http://gestion.mincit.gov.co/Athena/";
$_SESSION['modulo'] = "Gestión Entidad";
