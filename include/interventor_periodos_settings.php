...
$tdatainterventor_periodos[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatainterventor_periodos[".originalPagesByType"] = $tdatainterventor_periodos[".pagesByType"];
$tdatainterventor_periodos[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"import\":[\"import\"],\"list\":[\"list\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatainterventor_periodos[".originalPages"] = $tdatainterventor_periodos[".pages"];
$tdatainterventor_periodos[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"import\":\"import\",\"list\":\"list\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdatainterventor_periodos[".badgeColor"] = "008B8B";
...
$tdatainterventor_periodos[".sqlHead"] = "SELECT id_periodo,  	periodo_dias,  	periodo_meses,  	periodo_name,  	periodo_value";
...
$proto0["m_strFieldList"] = "id_periodo,  	periodo_dias,  	periodo_meses,  	periodo_name,  	periodo_value";
