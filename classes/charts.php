...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("funcionario" == $this->chrt_array['tables'][0])
			return true;
		if("nombramiento" == $this->chrt_array['tables'][0])
			return true;
		if("contrato" == $this->chrt_array['tables'][0])
			return true;
		if("perfil" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_attached_type" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipo_ct_000" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipo_ct_001" == $this->chrt_array['tables'][0])
			return true;
		if("tparam_tipo_ct_002" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_estados" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_forma_pago" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_natjuridica" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_pre" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("contrato_tipo_unidad" == $this->chrt_array['tables'][0])
			return true;
		if("global_month" == $this->chrt_array['tables'][0])
			return true;
		if("interventor_periodos" == $this->chrt_array['tables'][0])
			return true;
		if("polizas_aseguradoras" == $this->chrt_array['tables'][0])
			return true;
		if("polizas_tipo" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_banco" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_cta_banco" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_docidentidad" == $this->chrt_array['tables'][0])
			return true;
		if("tipo_liquidacion" == $this->chrt_array['tables'][0])
			return true;
		if("vigencia" == $this->chrt_array['tables'][0])
			return true;
		...
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		if("global_rol_almacen" == $this->chrt_array['tables'][0])
			return true;
		if("global_rol_c" == $this->chrt_array['tables'][0])
			return true;
		if("ep_compromisos" == $this->chrt_array['tables'][0])
			return true;
		if("ep_obligaciones" == $this->chrt_array['tables'][0])
			return true;
		if("ep_agregada" == $this->chrt_array['tables'][0])
			return true;
		...
		if("global_status" == $this->chrt_array['tables'][0])
			return true;
		if("007_cdp" == $this->chrt_array['tables'][0])
			return true;
		if("ep_reservas" == $this->chrt_array['tables'][0])
			return true;
		if("gestionentidad_v108ugrights" == $this->chrt_array['tables'][0])
			return true;
		if("gestionentidad_v108ugmembers" == $this->chrt_array['tables'][0])
			return true;
		if("global_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
