...
function fillProjectEntites()
{
	...
	$projectEntities[ "nombramiento" ] = array( "url" => "nombramiento", "type" => 0 );
	$projectEntitiesReverse[ "nombramiento" ] = "nombramiento";
	$projectEntities[ "contrato" ] = array( "url" => "contrato", "type" => 0 );
	$projectEntitiesReverse[ "contrato" ] = "contrato";
	$projectEntities[ "perfil" ] = array( "url" => "perfil", "type" => 0 );
	$projectEntitiesReverse[ "perfil" ] = "perfil";
	...
	$projectEntities[ "contrato_estados" ] = array( "url" => "contrato_estados", "type" => 0 );
	$projectEntitiesReverse[ "contrato_estados" ] = "contrato_estados";
	$projectEntities[ "contrato_forma_pago" ] = array( "url" => "contrato_forma_pago", "type" => 0 );
	$projectEntitiesReverse[ "contrato_forma_pago" ] = "contrato_forma_pago";
	$projectEntities[ "contrato_natjuridica" ] = array( "url" => "contrato_natjuridica", "type" => 0 );
	$projectEntitiesReverse[ "contrato_natjuridica" ] = "contrato_natjuridica";
	$projectEntities[ "contrato_pre" ] = array( "url" => "contrato_pre", "type" => 0 );
	$projectEntitiesReverse[ "contrato_pre" ] = "contrato_pre";
	$projectEntities[ "contrato_tipo" ] = array( "url" => "contrato_tipo", "type" => 0 );
	$projectEntitiesReverse[ "contrato_tipo" ] = "contrato_tipo";
	...
	$projectEntities[ "global_month" ] = array( "url" => "global_month", "type" => 0 );
	$projectEntitiesReverse[ "global_month" ] = "global_month";
	...
	$projectEntities[ "polizas_aseguradoras" ] = array( "url" => "polizas_aseguradoras", "type" => 0 );
	$projectEntitiesReverse[ "polizas_aseguradoras" ] = "polizas_aseguradoras";
	$projectEntities[ "polizas_tipo" ] = array( "url" => "polizas_tipo", "type" => 0 );
	$projectEntitiesReverse[ "polizas_tipo" ] = "polizas_tipo";
	...
	$projectEntities[ "tipo_liquidacion" ] = array( "url" => "tipo_liquidacion", "type" => 0 );
	$projectEntitiesReverse[ "tipo_liquidacion" ] = "tipo_liquidacion";
	$projectEntities[ "vigencia" ] = array( "url" => "vigencia", "type" => 0 );
	$projectEntitiesReverse[ "vigencia" ] = "vigencia";
	...
	$projectEntities[ "global_rol_almacen" ] = array( "url" => "global_rol_almacen", "type" => 0 );
	$projectEntitiesReverse[ "global_rol_almacen" ] = "global_rol_almacen";
	$projectEntities[ "global_rol_c" ] = array( "url" => "global_rol_c", "type" => 0 );
	$projectEntitiesReverse[ "global_rol_c" ] = "global_rol_c";
	...
	$projectEntities[ "ep_agregada" ] = array( "url" => "ep_agregada", "type" => 0 );
	$projectEntitiesReverse[ "ep_agregada" ] = "ep_agregada";
	...
	$projectEntities[ "ep_reservas" ] = array( "url" => "ep_reservas", "type" => 0 );
	$projectEntitiesReverse[ "ep_reservas" ] = "ep_reservas";
